...
public class DateUtils {
	...
	public static String getThisWeekMondayDate(){
		...
		return getStringDate(c.getTime(),"yyyy-MM-dd");
	}
	...
	public static String getThisMonthFirstDate(){
		...
		c.add(Calendar.DATE, -day_of_month);
		return getStringDate(c.getTime(),"yyyy-MM-dd");
	}
	...
	public static void main(String args[]){
		...
		System.out.println(getThisWeekMondayDate());
		System.out.println(getThisMonthFirstDate());
