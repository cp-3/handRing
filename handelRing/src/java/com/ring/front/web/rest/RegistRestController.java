...
public class RegistRestController extends BaseRest {
	...
	public HashMap<String,String> regist(@RequestParam(value = "email", required = false) String email,
...
//		}
		...
		if(userInfoService.emailIsRegisted(email)){
			json.put("retCode",  WebConstants.RETURN_FAIL_CODE);
			json.put("retMsg",  "邮箱【"+email+"】已被注册！");
			return json;
		}
